...
we used naive approach to find the occurances and appending it in the answer and cutting down the n
"""
    ...
    def nextseq(n,seq):
        ...
        for i in seq[1:]:
            if i == prev:
                ...
                nex.extend([str(cnt),prev])
                prev = i
                cnt = 1
        nex.append("E")
        return nextseq(n-1,nex)
            
    return "".join(nextseq(n,["1","E"]))
"""
TC = o(2^n)
SC = o(2^n-1)
"""